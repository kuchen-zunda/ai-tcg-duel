...
export interface PlayerSide {
  boss: Boss; adv: Adventurer[]; hand: Id[]; deck: Id[]; discard: Id[];
  fieldBoss?: Id | null; fieldAdv?: Id | null;
  flags: { supportUsedThisTurn: boolean };
}
export interface GameState {
  id: Id; turn: "P1"|"P2"; phase: "draw"|"main"|"boss"|"end";
  status: GameStatus;             // ← 追加
  p1: PlayerSide; p2: PlayerSide;
