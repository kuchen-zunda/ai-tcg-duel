const cards: any = {
  adventurers: [
    { id:"adv_rio",   name:"剣士リオ", hp:20, atk:4, max_ap:2, actions:[
    ...
    { id:"adv_luna",  name:"僧侶ルゥナ", hp:16, atk:2, max_ap:3, actions:[
    ...
    { id:"adv_kana",  name:"弓手カナ", hp:18, atk:3, max_ap:2, actions:[
      { name:"攻撃", type:"attack_boss_only", damage:3, cost_ap:0 },
      { name:"強撃", type:"attack_boss_only", damage:6, cost_ap:2 },
      { name:"回避", type:"defend", reduce:99, cost_ap:1 }
    ]},
    { id:"adv_ceris", name:"魔導師セリス", hp:14, atk:1, max_ap:3, actions:[
    ...
    // 要望の2人
    { id:"adv_toma",  name:"盗賊トウマ", hp:17, atk:3, max_ap:2, actions:[
      { name:"攻撃", type:"attack_boss_only", damage:3, cost_ap:0 },
      { name:"奇襲", type:"attack_boss_only", damage:5, cost_ap:1 },
      { name:"煙幕", type:"defend", reduce:4, cost_ap:1 }
    ]},
    { id:"adv_sei",   name:"守護者セイ", hp:22, atk:2, max_ap:2, actions:[
      { name:"攻撃", type:"attack_boss_only", damage:2, cost_ap:0 },
      { name:"挑発", type:"defend", reduce:5, cost_ap:1 },
      { name:"鉄壁", type:"defend", reduce:7, cost_ap:2 }
    ]},
  ],
  bosses: [
    { id:"boss_tomb", name:"墓所の王", hp:40, dice_table:{
    ...
    { id:"boss_gale", name:"翠嵐の領主", hp:38, dice_table:{
  ...
  supports: [
    { name:"癒しの光" }, { name:"魔力の加護" }, { name:"絆の記録" },
    { name:"迅速の符" }, { name:"鉄壁の守り" }, { name:"幻惑の囁き" }
  ],
  equipment: [
  ...
  events: [
    { name:"追憶の手帳", effect:"draw_if_fallen" }
  ],
  fields: [
    { name:"古戦場" }, { name:"静寂の聖域" }
  ]
